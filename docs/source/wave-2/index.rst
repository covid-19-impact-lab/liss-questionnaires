...
The questions are documented in Dutch and English under :ref:`wave2_questions_dutch` and :ref:`wave2_questions_english` respectively. Each page contains the question and a screenshot from the questionnaire as it was shown to respondents.
