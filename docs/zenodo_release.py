...
# configuration
deposition_url = 'https://sandbox.zenodo.org/deposit/674423' # for testing, needs token from sandbox.zenodo.org
#deposition_url = 'https://zenodo.org/api/deposit/depositions/1485438'
pdf_file_name = 'covid-19impactlabquestionnaire.pdf'
